...
export default function CustomizedInput() {
  ...
  return (
    <Paper
      component="form"
      sx={{ p: '10px 10px', display: 'flex', alignItems: 'center', width: {width}, height: 35, backgroundColor: fillinColor, boxShadow: 3 }}
    >
      <InputBase
      ...
      />
      <IconButton type="submit" style={{ color: 'grey'  }} sx={{ p: '10px', }} aria-label="search">
        <SearchIcon />
      </IconButton>
    </Paper>
  );
